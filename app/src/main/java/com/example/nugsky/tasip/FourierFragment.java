 ...
 * {@link FourierFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FourierFragment#newInstance} factory method to
...
public class FourierFragment extends Fragment {
     ...
     * @return A new instance of fragment FourierFragment.
     */
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == Utils.PICK_IMAGE){
            Utils.passImage(this,this.getContext(),data,FourierActivity.class);
        }
    }
